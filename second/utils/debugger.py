...
class Debugger(object):
    ...
    def add_point(self, point, c=(0, 0, 255), img_id='default'):
    ...
    def add_3d_detection2(self, corners, c=[0, 255, 0], img_id='det'):
        self.imgs[img_id] = draw_box_3d(self.imgs[img_id], corners, c)
